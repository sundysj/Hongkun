...
namespace Com.Alipay
{
    ...
    public class Core
    {
        ...
        public static string CreateLinkNotifyString(Dictionary<string, string> dicArray)
        {
        ...
        {
            string strPath =new Config().log_path + "\\" + "alipay_log_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".txt";
