...
namespace Business
{
    ...
    public class ReceFeesPrec
    {
        ...
        public static int ReceivePrecFees(int iCommID, long iCustID, long iRoomID, string strCostIDs
            , string strChargeMode, decimal iPrecAmount, string strUserCode, ref string HitResult, ref string ErrMsg, ref long iReceID, long HandID = 0)
        {
            int iReturn = 0;
            bool IsPrint = true;
        ...
        #region 华宇预存
        public static int ReceivePrecFees_HY(int iCommID, long iCustID, long iRoomID, string[] CostIDs
            , string strChargeMode, string[] iPrecAmounts, string strUserCode, ref string HitResult, ref string ErrMsg, ref long iReceID)
        {
            int iReturn = 0;
            bool IsPrint = true;
                ...
                if (dTableDetail != null)
                {
                    if (dTableDetail.Rows.Count != 0)
                    {
                        ...
                        if (iFeesLimitCount > 0)
                        {
                            ...
                            #region  回發票據號
                            string ContionStringr = Global_Var.CorpSQLConnstr.ToString();
                            string strSqlr = " select BillsSign,BillsDate   from Tb_HSPR_PreCostsReceipts where receid='" + iReceID + "' ";
                            DataTable dtr = new DbHelperSQLP(ContionStringr).Query(strSqlr).Tables[0];
                            if (dtr.Rows.Count > 0)
                            {
                            ...
                            {
                                HitResult = JSONHelper.FromString(false, "预存费用失败！"); ;
                                IsPrint = false;
                            }
                        }
                    }
                    ...
                    {
                        HitResult = JSONHelper.FromString(false, "请添加需要预交的费用！"); ;
        ...
        #region POS机预收
        public static int ReceivePrecFees_POS(string Memo, int iCommID, long iCustID, long iRoomID, string strCostIDs
            , string strChargeMode, decimal iPrecAmount, string strUserCode, ref string HitResult, ref string strBillsDate, ref string ErrMsg, ref long iReceID)
        {
            int iReturn = 0;
            bool IsPrint = true;
        ...
        public static DataTable HSPR_PreCostsDetail_Filter(string SQLEx)
        {
            ...
            DataSet Ds = new DbHelperSQLP(Global_Var.CorpSQLConnstr.ToString()).RunProcedure("Proc_HSPR_PreCostsDetail_Filter", parameters, "Ds");
            return Ds.Tables[0];
        }
        ...
        public static DataTable HSPR_BillUse_GetBillsSignUseRange(int CommID, string UserCode, string UseRange)
        {
            ...
            DataSet Ds = new DbHelperSQLP(Global_Var.CorpSQLConnstr.ToString()).RunProcedure("Proc_HSPR_BillUse_GetBillsSignUseRange", parameters, "Ds");
            return Ds.Tables[0];
        }
            ...
            , string SQLEx1, string SQLEx2, string SQLEx3, string SQLEx4, string SQLEx5, string SQLEx6, string SQLEx7, string SQLEx8, string SQLEx9, string SQLEx10)
        {
            ...
            DataSet Ds = new DbHelperSQLP(Global_Var.CorpSQLConnstr.ToString()).RunProcedure("Proc_HSPR_PreCostsReceipts_InsertAuto", parameters, "Ds");
        ...
        public static void HSPR_BillUseInstead_InsUpdate(int CommID, long BillTypeID, string BillsSign, string UserCode, long SourceID, int SourceType, int BillUseCase)
        {
            ...
            DataSet Ds = new DbHelperSQLP(Global_Var.CorpSQLConnstr.ToString()).RunProcedure("Proc_HSPR_BillUseInstead_InsUpdate", parameters, "Ds");
        }
        ...
        public static void HSPR_BillUse_UpdateData(int CommID, long BillTypeID, string BillsSign)
        {
            ...
            parameters[1].Value = BillTypeID;
            parameters[2].Value = BillsSign;
            DataSet Ds = new DbHelperSQLP(Global_Var.CorpSQLConnstr.ToString()).RunProcedure("Proc_HSPR_BillUse_UpdateData", parameters, "Ds");
        }

        #region 预收-融科
        public static int ReceivePrecFees_RK(int iCommID, long iCustID, long iRoomID, string strCostIDs
            , string strChargeMode, decimal iPrecAmount, string strUserCode, string PrecMemo, ref string HitResult, ref string ErrMsg, ref long iReceID)
        {
            int iReturn = 0;
            bool IsPrint = true;
