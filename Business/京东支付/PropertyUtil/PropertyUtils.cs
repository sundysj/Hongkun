...
namespace Business.PropertyUtil
{
    public class PropertyUtils
    {
        ...
        static PropertyUtils()
        {
            ...
            propertyDictionary.AddOrPeplace("wepay.server.cancelUserRelation.url", "https://paygate.jd.com/service/cancelUserRelation");
            propertyDictionary.AddOrPeplace("wepay.server.getUserRelation.url", "https://paygate.jd.com/service/getUserRelation");

            propertyDictionary.AddOrPeplace("wepay.server.queryBaiTiaoFQ.url", "https://paygate.jd.com/service/queryBaiTiaoFQ");
