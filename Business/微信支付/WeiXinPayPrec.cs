...
namespace Business
{
    public class WeiXinPayPrec : PubInfo
    {
        ...
        public WeiXinPayPrec() //获取小区、项目信息
        {
            base.Token = "20160804WeiXinPayPrec";
        }
        ...
        /// <returns></returns>
        public string GenerateBankOrder(string CommunityId, string CustID, string RoomID, string out_trade_no, string txnTime, string total_fee, ref bool R, ref string BankOrderId, ref WxPayData WPD, WxPayConfig wxPayConfig, string openId = "")
        {
        ...
        public DataSet PropertyOrder(string CustId, string CostID, string CommID, string RoomID, string merId, string txnTime, string CommunityId, string PrecAmount)
        {
            ...
            DataSet Ds = new DbHelperSQLP(ConnStr).RunProcedure("Proc_OL_GenerateOrder_WeiXin_Prec", parameters, "Ds");
            return Ds;
        }
