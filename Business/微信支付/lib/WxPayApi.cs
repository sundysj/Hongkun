    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            inputObj.SetValue("appid",new WxPayConfig().APPID);//公众账号ID
            inputObj.SetValue("mch_id", new WxPayConfig().MCHID);//商户号
       ...
       */
        ...
        */
        ...
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", new WxPayConfig().MCHID, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999));
        }
