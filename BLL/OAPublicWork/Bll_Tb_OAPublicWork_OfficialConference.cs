...
{
	/// <summary>
	/// 业务逻辑类Bll_Tb_OAPublicWork_OfficialConference 的摘要说明。
	/// </summary>
	public class Bll_Tb_OAPublicWork_OfficialConference
	{
		private readonly MobileSoft.DAL.OAPublicWork.Dal_Tb_OAPublicWork_OfficialConference dal=new MobileSoft.DAL.OAPublicWork.Dal_Tb_OAPublicWork_OfficialConference();
		public Bll_Tb_OAPublicWork_OfficialConference()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_OfficialConference GetModelByCache(int InfoId)
		{
			
			string CacheKey = "Tb_OAPublicWork_OfficialConferenceModel-" + InfoId;
			...
			return (MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_OfficialConference)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_OfficialConference> GetModelList(string strWhere)
		{
