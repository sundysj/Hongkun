...
{
	/// <summary>
	/// 业务逻辑类Bll_Tb_Sys_PowerNodeRole 的摘要说明。
	/// </summary>
	public class Bll_Tb_Sys_PowerNodeRole
	{
		private readonly MobileSoft.DAL.SQMSys.Dal_Tb_Sys_PowerNodeRole dal=new MobileSoft.DAL.SQMSys.Dal_Tb_Sys_PowerNodeRole();
		public Bll_Tb_Sys_PowerNodeRole()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole GetModelByCache(long IID)
		{
			
			string CacheKey = "Tb_Sys_PowerNodeRoleModel-" + IID;
			...
			return (MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole> DataTableToList(DataTable dt)
		{
			List<MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole> modelList = new List<MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeRole();
