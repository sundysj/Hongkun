...
{
	/// <summary>
	/// 业务逻辑类Bll_Tb_Sys_RolePope 的摘要说明。
	/// </summary>
	public class Bll_Tb_Sys_RolePope
	{
		private readonly MobileSoft.DAL.SQMSys.Dal_Tb_Sys_RolePope dal=new MobileSoft.DAL.SQMSys.Dal_Tb_Sys_RolePope();
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public MobileSoft.Model.SQMSys.Tb_Sys_RolePope GetModelByCache(long IID)
		{
			...
			return (MobileSoft.Model.SQMSys.Tb_Sys_RolePope)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MobileSoft.Model.SQMSys.Tb_Sys_RolePope> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MobileSoft.Model.SQMSys.Tb_Sys_RolePope> DataTableToList(DataTable dt)
		{
			List<MobileSoft.Model.SQMSys.Tb_Sys_RolePope> modelList = new List<MobileSoft.Model.SQMSys.Tb_Sys_RolePope>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MobileSoft.Model.SQMSys.Tb_Sys_RolePope model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new MobileSoft.Model.SQMSys.Tb_Sys_RolePope();
