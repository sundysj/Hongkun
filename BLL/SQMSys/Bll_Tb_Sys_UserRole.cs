...
namespace MobileSoft.BLL.SQMSys
{
	...
	{
		private readonly MobileSoft.DAL.SQMSys.Dal_Tb_Sys_UserRole dal=new MobileSoft.DAL.SQMSys.Dal_Tb_Sys_UserRole();
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public MobileSoft.Model.SQMSys.Tb_Sys_UserRole GetModelByCache(Guid UserRoleCode)
		{
			...
			return (MobileSoft.Model.SQMSys.Tb_Sys_UserRole)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MobileSoft.Model.SQMSys.Tb_Sys_UserRole> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MobileSoft.Model.SQMSys.Tb_Sys_UserRole> DataTableToList(DataTable dt)
		{
			List<MobileSoft.Model.SQMSys.Tb_Sys_UserRole> modelList = new List<MobileSoft.Model.SQMSys.Tb_Sys_UserRole>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MobileSoft.Model.SQMSys.Tb_Sys_UserRole model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new MobileSoft.Model.SQMSys.Tb_Sys_UserRole();
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
            ...
            {
                  return Sys_User_FilterRoles(UserCode, StreetCode);
            }
	}
}
