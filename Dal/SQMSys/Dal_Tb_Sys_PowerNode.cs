...
{
	/// <summary>
	/// 数据访问类Dal_Tb_Sys_PowerNode。
	/// </summary>
	public class Dal_Tb_Sys_PowerNode
	{
		public Dal_Tb_Sys_PowerNode()
		{
		...
		public bool Exists(string PNodeCode)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNode_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public void Add(MobileSoft.Model.SQMSys.Tb_Sys_PowerNode model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNode_ADD",parameters,out rowsAffected);
		}
		...
		public void Update(MobileSoft.Model.SQMSys.Tb_Sys_PowerNode model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNode_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(string PNodeCode)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNode_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.SQMSys.Tb_Sys_PowerNode GetModel(string PNodeCode)
		{
			...
			MobileSoft.Model.SQMSys.Tb_Sys_PowerNode model=new MobileSoft.Model.SQMSys.Tb_Sys_PowerNode();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNode_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_Sys_PowerNode ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_Sys_PowerNode WHERE 1=1 " + StrCondition;
