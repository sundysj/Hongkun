...
namespace MobileSoft.DAL.SQMSys
{
	...
	public class Dal_Tb_Sys_Department
	{
		...
		public void Add(MobileSoft.Model.SQMSys.Tb_Sys_Department model)
		{
			...
			parameters[2].Value = model.DepName;
		...
		public MobileSoft.Model.SQMSys.Tb_Sys_Department GetModel(string DepCode,Guid StreetCode)
		{
			...
			MobileSoft.Model.SQMSys.Tb_Sys_Department model=new MobileSoft.Model.SQMSys.Tb_Sys_Department();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select DepCode,StreetCode,DepName,Principal,Memo,IsDelete,Sort,IsHide ");
		...
		public DataSet GetList(int Top,string strWhere,string fieldOrder)
		{
			...
			strSql.Append(" DepCode,StreetCode,DepName,Principal,Memo,IsDelete,Sort,IsHide ");
			strSql.Append(" FROM Tb_Sys_Department ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[6].Value = "DepCode,StreetCode";
