...
{
	/// <summary>
	/// 数据访问类Dal_Tb_Sys_Log_his。
	/// </summary>
	public class Dal_Tb_Sys_Log_his
	{
		public Dal_Tb_Sys_Log_his()
		{
		...
		public bool Exists(long LogCode)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_Sys_Log_his_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(MobileSoft.Model.SQMSys.Tb_Sys_Log_his model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_Log_his_ADD",parameters,out rowsAffected);
		...
		public void Update(MobileSoft.Model.SQMSys.Tb_Sys_Log_his model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_Log_his_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(long LogCode)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_Log_his_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.SQMSys.Tb_Sys_Log_his GetModel(long LogCode)
		{
			...
			MobileSoft.Model.SQMSys.Tb_Sys_Log_his model=new MobileSoft.Model.SQMSys.Tb_Sys_Log_his();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_Sys_Log_his_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_Sys_Log_his ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_Sys_Log_his WHERE 1=1 " + StrCondition;
