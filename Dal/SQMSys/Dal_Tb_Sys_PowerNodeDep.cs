...
{
	/// <summary>
	/// 数据访问类Dal_Tb_Sys_PowerNodeDep。
	/// </summary>
	public class Dal_Tb_Sys_PowerNodeDep
	{
		public Dal_Tb_Sys_PowerNodeDep()
		{
		...
		public bool Exists(long IID)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNodeDep_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeDep model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNodeDep_ADD",parameters,out rowsAffected);
		...
		public void Update(MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeDep model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNodeDep_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(long IID)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNodeDep_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeDep GetModel(long IID)
		{
			...
			MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeDep model=new MobileSoft.Model.SQMSys.Tb_Sys_PowerNodeDep();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_Sys_PowerNodeDep_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_Sys_PowerNodeDep ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_Sys_PowerNodeDep WHERE 1=1 " + StrCondition;
