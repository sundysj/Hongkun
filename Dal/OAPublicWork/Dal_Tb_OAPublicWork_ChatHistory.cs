...
{
	/// <summary>
	/// 数据访问类Dal_Tb_OAPublicWork_ChatHistory。
	/// </summary>
	public class Dal_Tb_OAPublicWork_ChatHistory
	{
		public Dal_Tb_OAPublicWork_ChatHistory()
		{
		...
		public bool Exists(long InfoId)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_ChatHistory_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_ChatHistory model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_ChatHistory_ADD",parameters,out rowsAffected);
		...
		public void Update(MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_ChatHistory model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_ChatHistory_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(long InfoId)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_ChatHistory_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_ChatHistory GetModel(long InfoId)
		{
			...
			MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_ChatHistory model=new MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_ChatHistory();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_ChatHistory_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_OAPublicWork_ChatHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_OAPublicWork_ChatHistory WHERE 1=1 " + StrCondition;
