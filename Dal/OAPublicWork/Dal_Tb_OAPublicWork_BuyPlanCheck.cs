...
{
	/// <summary>
	/// 数据访问类Dal_Tb_OAPublicWork_BuyPlanCheck。
	/// </summary>
	public class Dal_Tb_OAPublicWork_BuyPlanCheck
	{
		public Dal_Tb_OAPublicWork_BuyPlanCheck()
		{
		...
		public bool Exists(int InfoId)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_BuyPlanCheck_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		///  增加一条数据
		/// </summary>
		public int Add(MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_BuyPlanCheck model)
		{
			int rowsAffected;
			SqlParameter[] parameters = {
					new SqlParameter("@InfoId", SqlDbType.Int,4),
					...
					new SqlParameter("@ReceiptID", SqlDbType.NVarChar,50),
					new SqlParameter("@PlanId", SqlDbType.NVarChar,50)};
			...
			parameters[11].Value = model.ReceiptID;
			parameters[12].Value = model.PlanId;

			DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_BuyPlanCheck_ADD",parameters,out rowsAffected);
		...
		///  更新一条数据
		/// </summary>
		public void Update(MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_BuyPlanCheck model)
		{
			int rowsAffected;
			SqlParameter[] parameters = {
					new SqlParameter("@InfoId", SqlDbType.Int,4),
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_BuyPlanCheck_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(int InfoId)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_BuyPlanCheck_Delete",parameters,out rowsAffected);
		}

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		public MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_BuyPlanCheck GetModel(int InfoId)
		{
			SqlParameter[] parameters = {
					new SqlParameter("@InfoId", SqlDbType.Int,4)};
			parameters[0].Value = InfoId;

			MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_BuyPlanCheck model=new MobileSoft.Model.OAPublicWork.Tb_OAPublicWork_BuyPlanCheck();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_OAPublicWork_BuyPlanCheck_GetModel",parameters,"ds");
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				model.ReceiptID=ds.Tables[0].Rows[0]["ReceiptID"].ToString();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select InfoId,Tb_WorkFlow_FlowSort_InfoId,UserCode,Title,DepCode,BuyPlanDate,BuyPlanMoney,NeedDate,BuyPlanReadMe,DocumentUrl,WorkStartDate,ReceiptID,PlanId ");
			strSql.Append(" FROM Tb_OAPublicWork_BuyPlanCheck ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string fieldOrder)
		{
			...
			strSql.Append(" InfoId,Tb_WorkFlow_FlowSort_InfoId,UserCode,Title,DepCode,BuyPlanDate,BuyPlanMoney,NeedDate,BuyPlanReadMe,DocumentUrl,WorkStartDate,ReceiptID,PlanId ");
			strSql.Append(" FROM Tb_OAPublicWork_BuyPlanCheck ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_OAPublicWork_BuyPlanCheck WHERE 1=1 " + StrCondition;
