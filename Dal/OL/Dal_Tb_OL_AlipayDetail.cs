...
{
	/// <summary>
	/// 数据访问类Dal_Tb_OL_AlipayDetail。
	/// </summary>
	public class Dal_Tb_OL_AlipayDetail
	{
		public Dal_Tb_OL_AlipayDetail()
		{
		...
		public bool Exists(string Id)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_OL_AlipayDetail_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public void Add(MobileSoft.Model.OL.Tb_OL_AlipayDetail model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OL_AlipayDetail_ADD",parameters,out rowsAffected);
		}
		...
		public void Update(MobileSoft.Model.OL.Tb_OL_AlipayDetail model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OL_AlipayDetail_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(string Id)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OL_AlipayDetail_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.OL.Tb_OL_AlipayDetail GetModel(string Id)
		{
			...
			MobileSoft.Model.OL.Tb_OL_AlipayDetail model=new MobileSoft.Model.OL.Tb_OL_AlipayDetail();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_OL_AlipayDetail_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_OL_AlipayDetail ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_OL_AlipayDetail WHERE 1=1 " + StrCondition;
