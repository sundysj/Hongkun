...
{
	/// <summary>
	/// 数据访问类Dal_Tb_OL_UnionPayDetail。
	/// </summary>
	public class Dal_Tb_OL_UnionPayDetail
	{
		public Dal_Tb_OL_UnionPayDetail()
		{
		...
		public bool Exists(string Id)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_OL_UnionPayDetail_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public void Add(MobileSoft.Model.OL.Tb_OL_UnionPayDetail model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OL_UnionPayDetail_ADD",parameters,out rowsAffected);
		}
		...
		public void Update(MobileSoft.Model.OL.Tb_OL_UnionPayDetail model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OL_UnionPayDetail_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(string Id)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_OL_UnionPayDetail_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.OL.Tb_OL_UnionPayDetail GetModel(string Id)
		{
			...
			MobileSoft.Model.OL.Tb_OL_UnionPayDetail model=new MobileSoft.Model.OL.Tb_OL_UnionPayDetail();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_OL_UnionPayDetail_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_OL_UnionPayDetail ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_OL_UnionPayDetail WHERE 1=1 " + StrCondition;
