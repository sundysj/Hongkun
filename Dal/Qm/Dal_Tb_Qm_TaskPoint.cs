...
{
	/// <summary>
	/// 数据访问类Dal_Tb_Qm_TaskPoint。
	/// </summary>
	public class Dal_Tb_Qm_TaskPoint
	{
		public Dal_Tb_Qm_TaskPoint()
		{
		...
		public void Add(HM.Model.Qm.Tb_Qm_TaskPoint model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskPoint_ADD",parameters,out rowsAffected);
		}
		...
		public void Update(HM.Model.Qm.Tb_Qm_TaskPoint model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskPoint_Update",parameters,out rowsAffected);
		}
		...
		public void Delete()
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskPoint_Delete",parameters,out rowsAffected);
		}
		...
		public HM.Model.Qm.Tb_Qm_TaskPoint GetModel()
		{
			...
			HM.Model.Qm.Tb_Qm_TaskPoint model=new HM.Model.Qm.Tb_Qm_TaskPoint();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskPoint_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_Qm_TaskPoint ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_Qm_TaskPoint WHERE 1=1 " + StrCondition;
			parameters[6].Value = "";
