...
{
	/// <summary>
	/// 数据访问类Dal_Tb_Qm_TaskFiles。
	/// </summary>
	public class Dal_Tb_Qm_TaskFiles
	{
		public Dal_Tb_Qm_TaskFiles()
		{
		...
		public bool Exists(string Id)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskFiles_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public void Add(HM.Model.Qm.Tb_Qm_TaskFiles model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskFiles_ADD",parameters,out rowsAffected);
		}
		...
		public void Update(HM.Model.Qm.Tb_Qm_TaskFiles model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskFiles_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(string Id)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskFiles_Delete",parameters,out rowsAffected);
		}
		...
		public HM.Model.Qm.Tb_Qm_TaskFiles GetModel(string Id)
		{
			...
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_Qm_TaskFiles_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select Id,TaskId,FileName,Fix,IsDelete,FilePath,PhoneName,PhotoTime,PhotoPId ");
			strSql.Append(" FROM Tb_Qm_TaskFiles ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,TaskId,FileName,Fix,IsDelete,FilePath,PhoneName,PhotoTime,PhotoPId ");
			strSql.Append(" FROM Tb_Qm_TaskFiles ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_Qm_TaskFiles WHERE 1=1 " + StrCondition;
