...
{
	/// <summary>
	/// 数据访问类Dal_Tb_Sys_TakePicSecRoomState。
	/// </summary>
	public class Dal_Tb_Sys_TakePicSecRoomState
	{
		public Dal_Tb_Sys_TakePicSecRoomState()
		{
		...
		public bool Exists(long StatID)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicSecRoomState_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(MobileSoft.Model.Sys.Tb_Sys_TakePicSecRoomState model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicSecRoomState_ADD",parameters,out rowsAffected);
		...
		public void Update(MobileSoft.Model.Sys.Tb_Sys_TakePicSecRoomState model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicSecRoomState_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(long StatID)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicSecRoomState_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.Sys.Tb_Sys_TakePicSecRoomState GetModel(long StatID)
		{
			...
			MobileSoft.Model.Sys.Tb_Sys_TakePicSecRoomState model=new MobileSoft.Model.Sys.Tb_Sys_TakePicSecRoomState();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicSecRoomState_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select StatID,StatType,CommID,OrganCode,StatDate,RoomState,Counts ");
			strSql.Append(" FROM Tb_Sys_TakePicSecRoomState ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string fieldOrder)
		{
			...
			strSql.Append(" StatID,StatType,CommID,OrganCode,StatDate,RoomState,Counts ");
			strSql.Append(" FROM Tb_Sys_TakePicSecRoomState ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_Sys_TakePicSecRoomState WHERE 1=1 " + StrCondition;
