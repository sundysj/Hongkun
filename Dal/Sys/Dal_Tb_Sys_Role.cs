...
namespace MobileSoft.DAL.Sys
{
	...
	public class Dal_Tb_Sys_Role
	{
		...
		public void Add(MobileSoft.Model.Sys.Tb_Sys_Role model)
		{
			...
			parameters[3].Value = model.IsSysRole;
		...
		public MobileSoft.Model.Sys.Tb_Sys_Role GetModel(string RoleCode)
		{
			...
			MobileSoft.Model.Sys.Tb_Sys_Role model=new MobileSoft.Model.Sys.Tb_Sys_Role();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select RoleCode,RoleName,RoleDescribe,IsSysRole,CommID,DepCode,SysRoleCode ");
		...
		public DataSet GetList(int Top,string strWhere,string fieldOrder)
		{
			...
			strSql.Append(" RoleCode,RoleName,RoleDescribe,IsSysRole,CommID,DepCode,SysRoleCode ");
			strSql.Append(" FROM Tb_Sys_Role ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
