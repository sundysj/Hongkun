...
namespace MobileSoft.DAL.Sys
{
	...
	public class Dal_Tb_Sys_RolePope
	{
		...
		public MobileSoft.Model.Sys.Tb_Sys_RolePope GetModel(long IID)
		{
			...
			MobileSoft.Model.Sys.Tb_Sys_RolePope model=new MobileSoft.Model.Sys.Tb_Sys_RolePope();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select IID,RoleCode,PNodeCode,Functions ");
		...
		public DataSet GetList(int Top,string strWhere,string fieldOrder)
		{
			...
			strSql.Append(" IID,RoleCode,PNodeCode,Functions ");
			strSql.Append(" FROM Tb_Sys_RolePope ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
