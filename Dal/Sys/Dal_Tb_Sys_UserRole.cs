...
namespace MobileSoft.DAL.Sys
{
	...
	public class Dal_Tb_Sys_UserRole
	{
		...
		public MobileSoft.Model.Sys.Tb_Sys_UserRole GetModel(Guid UserRoleCode)
		{
			...
			MobileSoft.Model.Sys.Tb_Sys_UserRole model=new MobileSoft.Model.Sys.Tb_Sys_UserRole();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select UserRoleCode,UserCode,RoleCode ");
		...
		public DataSet GetList(int Top,string strWhere,string fieldOrder)
		{
			...
			strSql.Append(" UserRoleCode,UserCode,RoleCode ");
			strSql.Append(" FROM Tb_Sys_UserRole ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
