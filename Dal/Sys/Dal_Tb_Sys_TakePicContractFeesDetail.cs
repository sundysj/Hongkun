...
{
	/// <summary>
	/// 数据访问类Dal_Tb_Sys_TakePicContractFeesDetail。
	/// </summary>
	public class Dal_Tb_Sys_TakePicContractFeesDetail
	{
		public Dal_Tb_Sys_TakePicContractFeesDetail()
		{
		...
		public bool Exists(long DetailID)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicContractFeesDetail_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(MobileSoft.Model.Sys.Tb_Sys_TakePicContractFeesDetail model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@CostName", SqlDbType.NVarChar,50),
			...
			parameters[7].Value = model.CostName;
			parameters[8].Value = model.FeesDueDate;
			parameters[9].Value = model.DebtsAmount;

			DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicContractFeesDetail_ADD",parameters,out rowsAffected);
		...
		public void Update(MobileSoft.Model.Sys.Tb_Sys_TakePicContractFeesDetail model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicContractFeesDetail_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(long DetailID)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicContractFeesDetail_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.Sys.Tb_Sys_TakePicContractFeesDetail GetModel(long DetailID)
		{
			...
			MobileSoft.Model.Sys.Tb_Sys_TakePicContractFeesDetail model=new MobileSoft.Model.Sys.Tb_Sys_TakePicContractFeesDetail();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_Sys_TakePicContractFeesDetail_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select DetailID,CommID,OrganCode,ContTypeName,ContSign,ContName,CustName,CostName,FeesDueDate,DebtsAmount ");
			strSql.Append(" FROM Tb_Sys_TakePicContractFeesDetail ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string fieldOrder)
		{
			...
			strSql.Append(" DetailID,CommID,OrganCode,ContTypeName,ContSign,ContName,CustName,CostName,FeesDueDate,DebtsAmount ");
			strSql.Append(" FROM Tb_Sys_TakePicContractFeesDetail ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_Sys_TakePicContractFeesDetail WHERE 1=1 " + StrCondition;
