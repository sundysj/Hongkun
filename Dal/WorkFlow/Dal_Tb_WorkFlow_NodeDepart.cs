...
{
	/// <summary>
	/// 数据访问类Dal_Tb_WorkFlow_NodeDepart。
	/// </summary>
	public class Dal_Tb_WorkFlow_NodeDepart
	{
		public Dal_Tb_WorkFlow_NodeDepart()
		{
		...
		public void Add(MobileSoft.Model.WorkFlow.Tb_WorkFlow_NodeDepart model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_NodeDepart_ADD",parameters,out rowsAffected);
		}
		...
		public void Update(MobileSoft.Model.WorkFlow.Tb_WorkFlow_NodeDepart model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_NodeDepart_Update",parameters,out rowsAffected);
		}
		...
		public void Delete()
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_NodeDepart_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.WorkFlow.Tb_WorkFlow_NodeDepart GetModel()
		{
			...
			MobileSoft.Model.WorkFlow.Tb_WorkFlow_NodeDepart model=new MobileSoft.Model.WorkFlow.Tb_WorkFlow_NodeDepart();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_NodeDepart_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_WorkFlow_NodeDepart ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_WorkFlow_NodeDepart WHERE 1=1 " + StrCondition;
			parameters[6].Value = "";
            ...
            public DataTable GetWorkFlowNodeDepart(int InstanceId, string DictionaryCode)
            {
                  ...
                  parameters[2].Value = "Tb_WorkFlow_NodeDepart";
