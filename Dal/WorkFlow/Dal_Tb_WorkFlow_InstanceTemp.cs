...
{
	/// <summary>
	/// 数据访问类Dal_Tb_WorkFlow_InstanceTemp。
	/// </summary>
	public class Dal_Tb_WorkFlow_InstanceTemp
	{
		public Dal_Tb_WorkFlow_InstanceTemp()
		{
		...
		public bool Exists(int InfoId)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_InstanceTemp_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(MobileSoft.Model.WorkFlow.Tb_WorkFlow_InstanceTemp model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_InstanceTemp_ADD",parameters,out rowsAffected);
		...
		public void Update(MobileSoft.Model.WorkFlow.Tb_WorkFlow_InstanceTemp model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_InstanceTemp_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(int InfoId)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_InstanceTemp_Delete",parameters,out rowsAffected);
		}
		...
		public MobileSoft.Model.WorkFlow.Tb_WorkFlow_InstanceTemp GetModel(int InfoId)
		{
			...
			MobileSoft.Model.WorkFlow.Tb_WorkFlow_InstanceTemp model=new MobileSoft.Model.WorkFlow.Tb_WorkFlow_InstanceTemp();
			DataSet ds= DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_InstanceTemp_GetModel",parameters,"ds");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_WorkFlow_InstanceTemp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_WorkFlow_InstanceTemp WHERE 1=1 " + StrCondition;
