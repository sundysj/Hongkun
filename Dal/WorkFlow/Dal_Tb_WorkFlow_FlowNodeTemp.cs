...
{
	/// <summary>
	/// 数据访问类Dal_Tb_WorkFlow_FlowNodeTemp。
	/// </summary>
	public class Dal_Tb_WorkFlow_FlowNodeTemp
	{
		public Dal_Tb_WorkFlow_FlowNodeTemp()
		{
		...
		public bool Exists(int InfoId)
		{
			...
			int result= DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_FlowNodeTemp_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public void Update(MobileSoft.Model.WorkFlow.Tb_WorkFlow_FlowNodeTemp model)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_FlowNodeTemp_Update",parameters,out rowsAffected);
		}
		...
		public void Delete(int InfoId)
		{
			...
			DbHelperSQL.RunProcedure("Proc_Tb_WorkFlow_FlowNodeTemp_Delete",parameters,out rowsAffected);
		}
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Tb_WorkFlow_FlowNodeTemp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(out int PageCount, out int Counts, string StrCondition, int PageIndex, int PageSize,string SortField,int Sort)
		{
			...
			parameters[5].Value = "SELECT * FROM Tb_WorkFlow_FlowNodeTemp WHERE 1=1 " + StrCondition;
