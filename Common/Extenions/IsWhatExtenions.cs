...
namespace Common.Extenions
{
    ...
    {/// <summary>
     ...
     /// <returns></returns>
        ...
        /// <param name="thisValue"></param>
        /// <returns></returns>
        public static bool IsNumber(this object thisValue)
        {
            if (thisValue == null) return false;
        ...
        /// <param name="thisValue"></param>
        /// <returns></returns>
        public static bool IsNoNumber(this object thisValue)
        {
            if (thisValue == null) return true;
            return !Regex.IsMatch(thisValue.ToString(), @"^\d+$");
        }
        ...
        {
            if (thisValue == null) return false;
            return double.TryParse(thisValue.ToString(), out double outValue);
        }
